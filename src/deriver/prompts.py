...
Example (target peer id `alice`, message `<message idx="0" peer="alice" target="true">I just turned 25</message>`):
{{"explicit":[{{"content":"alice is 25 years old"}}]}}

Example (target peer id `alice`, message `<message idx="1" peer="alice" target="true">I took my dog for a walk in NYC</message>`):
{{"explicit":[{{"content":"alice has a dog"}},{{"content":"alice walked her dog in NYC"}}]}}

Example (target peer id `alice`, message `<message idx="2" peer="alice" target="true">I've lived in NYC for six years</message>`):
{{"explicit":[{{"content":"alice lives in NYC"}},{{"content":"alice has lived in NYC for six years"}}]}}

Example (target peer id `alice`, message `<message idx="3" peer="assistant" target="false">I read the config file and found the port is 8080</message>`):
{{"explicit":[]}}
</examples>
